...
public class RedisPreparedStatement extends RedisAbstractStatement implements PreparedStatement {
    ...
    public boolean execute() throws SQLException {
        ...
        while (this.sql.indexOf("?") > 1) {
            try {
                ...
                this.sql = this.sql.replaceFirst("\\Q\u003F\\E",
                        parameter == null ? "null" : quoteReplacement(parameter));
    ...
    public void setObject(int parameterIndex, Object x) throws SQLException {
        this.pushIntoParameters(parameterIndex, String.valueOf(x));
    }
